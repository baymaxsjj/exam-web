<template>
    ...
    <APageHeader @back="$router.back()" title="自动组卷">
        <template #extra>
            <div>
                <AButton :loading="loading" status="danger" @click="submit" style="margin:0 10px ;">自动组卷</AButton>
        ...
        <ACol :span="12">
            <div class="config">
                ...
                <AForm :model="form">
                    ...
                    <AFormItem  tooltip="期望题型占比：1:1就是个各50%" label="期望题型">
                        <a-checkbox-group v-model="form.questionType" @change="cancelType">
                            <template v-for="item of questionType" :key="item.enumName">
                                <div style="display: flex;">
                                    ...
                                    <AInputNumber style="margin: 5px 0;"  mode="button"    v-model="form.percentage[item.enumName]"
                ...
                <ASpin :loading="loading" style="width:100%;">
                    <a-list :max-height="500">
                        ...
                        <a-list-item v-for="item of result.questionList" :key="item.id">
                            ...
                            <BaseQuestionPreview :question="item" :options="[]" />
                        </a-list-item>
                    </a-list>
                </ASpin>
            </div>
